using AutoMapper;
using GustoGlide.Services.ShoppingCartAPI.Data;
...
namespace GustoGlide.Services.ShoppingCartAPI.Controllers
{
    [Route("api/cart")]
    [ApiController]
    public class CartAPIController : ControllerBase
    {
        ...
        //    -- Create Cart Header
        //    -- Create Cart Details
        // 2) User adds a new item in the shpping cart. (User already has few other items un cart)
        //    -- Find Cart Header
        //    -- Add Cart Details under same Cart Header Id
        // 3) User updates quantity of an existing item in the cart
        //    -- Find Cart Details
        ...
        public async Task<ResponseDto> RemoveCart([FromBody] int cartDetailsId)
        {
            try
            {
                ...
                // if only 1 item in the shopping cart for that user - then we can remove the cart header as well    
